...
module.exports = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            ...
            // {from: 'src/*.scss', to: '.', context: '/'}
            // {from: 'src/app/*.scss', to: 'app'}
            // {from: 'src/components/*.scss', to: 'components', context: 'components/'},
            // {from: 'src/scenes/*.scss', to: 'scenes', context: 'scenes/'}
            // ,{ from: 'vendor.bundle.js', to: 'vendor.bundle.js', force:true }
            // ,{ from: 'assets/assets.json' }
            { from: 'src/app', to: 'app', ignore: [ '*.js' ] },
            { from: 'src/components', to: 'components', ignore: [ '*.js' ] },
            { from: 'src/styles', to: 'styles', ignore: [ '*.js' ] },
            { from: 'src/scenes', to: 'scenes', ignore: [ '*.js' ] }
        ])
    ]
    // ,
    // imagemin: {

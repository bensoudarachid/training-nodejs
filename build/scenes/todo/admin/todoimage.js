...
export default class TodoImage extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement('img', { id: 'todolistitemimg' + taskid, src: './images/0.png', 'data-src': ApiConnection.apiurl + ApiConnection.appbasename + '/api/todo/img/' + taskid + '?access_token=' + idToken,
        onLoad: this.handleImageLoaded.bind(this),
        onError: this.handleImageErrored.bind(this), className: 'dataimg', alt: 'coding' })
    );
    // return (

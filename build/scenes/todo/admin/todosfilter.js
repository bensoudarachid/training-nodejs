...
export default class TodosFilter extends React.Component {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { type: 'checkbox', id: 'checkbox1', className: 'bgo mdl-checkbox__input', ref: 'filterTodosOpen', defaultChecked: this.props.filteropen, onClick: this.handleFilterOpen.bind(this) }),
            React.createElement(
              'span',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { type: 'checkbox', id: 'checkbox2', className: 'bgr mdl-checkbox__input', ref: 'filterTodosClosed', defaultChecked: this.props.filterclosed, onClick: this.handleFilterClosed.bind(this) }),
            React.createElement(
              'span',
              { className: 'mdl-checkbox__label' },
              'Closed'
  ...
  renderOld() {
    ...
    return React.createElement(
      ...
      React.createElement('input', { type: 'checkbox', ref: 'filterOpen',
      ...
      React.createElement('input', { type: 'checkbox', ref: 'filterTodosClosed',

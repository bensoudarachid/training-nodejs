...
export default class TodosListItem extends React.Component {
  ...
  renderTaskForm() {
    ...
    const errorClass = error ? 'error' : '';
    const loadingClass = loading ? 'center-items loading' : '';
    const loadingContent = loading ? React.createElement('div', { className: 'loadingbar mdl-progress mdl-js-progress mdl-progress__indeterminate' }) : '';
    ...
    return React.createElement(
      ...
      this.state.isEditing ? React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('input', { className: 'mdl-textfield__input', type: 'text', defaultValue: task, name: 'taskInput' + index, ref: 'taskInput', id: 'taskInput' + index }),
              React.createElement(
                'label',
                { className: 'mdl-textfield__label', htmlFor: 'taskInput' + index },
                'Task...'
              )
            )
          )
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--4-col-phone', style: taskStyle, onClick: this.handleToggle.bind(this) },
            React.createElement(
              'p',
              null,
              task
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(FileUploadInput, { id: 'uploadfile-' + this.props.todo.get('id'), disabled: disabled, actions: this.props.actions })
          ),
          React.createElement(
            'div',
            { className: 'mdl-cell mdl-cell--5-col mdl-cell--2-col-tablet mdl-cell--2-col-phone' },
            React.createElement(TodoImage, { ref: 'uploadcomp', taskid: taskid, isUploading: isUploading }),
            React.createElement(
              'button',

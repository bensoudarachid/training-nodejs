    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'span',
          { id: 'textwrap' },
          React.createElement('p', { id: 'textswitch' })
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            React.createElement(TrainingCommandPanel, { trainings: this.props.trainingappmap.get('trainings'), actions: this.props.actions })
          ),
          React.createElement(AdminTrainingList, { trainings: this.props.trainingappmap.get('trainings'), actions: this.props.actions })
        )
      )
    );
  }
  ...
  textswitcher() {
    ...
    var loop = function () {
      ...
      setTimeout(function () {
        ...
        while (lastrdm === rdm) rdm = Math.floor(Math.random() * window.switchTextArray.length);
        // console.log('rdm = '+rdm +', lastrdm = '+lastrdm+' : '+window.switchTextArray[rdm]+' : ')
        lastrdm = rdm;
        // divContainer[0].style.display = 'none'
        //headShake 300 flash 300 fadeInLeft 300 rubberBand

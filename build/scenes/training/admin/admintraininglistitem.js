      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('button', { className: 'mdl-button mdl-js-button mdl-button--icon mdl-button--colored editbutton', onClick: this.handleEdit.bind(this) }),
            React.createElement('button', { className: 'mdl-button mdl-js-button mdl-button--icon mdl-button--colored schedulebutton', onClick: this.handleSchedule.bind(this) })
          )
        ),
        React.createElement(
          'div',

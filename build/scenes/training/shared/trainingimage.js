...
export default class TrainingImage extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement('img', { id: 'traininglistitemimg' + trainingid, src: './images/0.png', 'data-src': ApiConnection.apiurl + '/api/training/img/' + trainingid + '?access_token=' + idToken,
        onLoad: this.handleImageLoaded.bind(this),
        onError: this.handleImageErrored.bind(this), className: 'dataimg', alt: 'coding' })
    );
    // return (

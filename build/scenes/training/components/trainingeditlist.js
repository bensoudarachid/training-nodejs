...
var _trainingeditlistitem = require('./trainingeditlistitem');

var _trainingeditlistitem2 = _interopRequireDefault(_trainingeditlistitem);
...
var TrainingEditList = function (_React$Component) {
  _inherits(TrainingEditList, _React$Component);

  function TrainingEditList(props) {
    _classCallCheck(this, TrainingEditList);

    // console.log('training list. Mixin in constructor')
    var _this = _possibleConstructorReturn(this, (TrainingEditList.__proto__ || Object.getPrototypeOf(TrainingEditList)).call(this, props));

    _this.shouldComponentUpdate = _reactAddonsPureRenderMixin2.default.shouldComponentUpdate.bind(_this);
    return _this;
  }

  _createClass(TrainingEditList, [{
    ...
    value: function renderItems() {
      ...
      return items.map(function (training, index) {
        ...
        return _react2.default.createElement(_trainingeditlistitem2.default, { ind: index, training: training, actions: _this2.props.actions });
      });
    }
  }, {
    key: 'render',
  ...
  return TrainingEditList;
}(_react2.default.Component);

exports.default = TrainingEditList;
...
describe('TodosList', () => {
  ...
  it('find 4 TodosListItem components', function () {
    ...
    const wrapper = shallow(React.createElement(TodosList, { filteropen: filteropen, filterclosed: filterclosed, todos: todos }));
  ...
  it('renders a list with only the open items if only filterclosed is true', () => {
    ...
    const component = mount(React.createElement(TodosList, { filteropen: filteropen, filterclosed: filterclosed, todos: todos }));

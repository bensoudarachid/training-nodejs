...
export default class AppImage extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement('img', { id: 'applicationimg' + imgid, src: './images/0.png', 'data-src': ApiConnection.apiurl + ApiConnection.appbasename + '/api/' + api + '/img/' + imgid + '?width=' + width + '&height=' + height + '' + idTokenParam,
        onLoad: this.handleImageLoaded.bind(this),
        onError: this.handleImageErrored.bind(this), className: 'dataimg', alt: 'coding' })
    );
    // return (

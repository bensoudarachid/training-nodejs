    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('span', { className: 'glyphicon glyphicon-upload ' + disabled }),
          React.createElement('input', { ref: 'file_input_file', onChange: this.changeInputText, className: 'none', type: 'file', id: id, disabled: this.props.disabled })
        ),
        React.createElement(
          'label',

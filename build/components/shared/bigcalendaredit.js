...
class BigCalendarEdit extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { key: 'eventTitle' + eventId, className: 'mdl-grid mdl-grid--no-spacing mdl-cell mdl-cell--7-col mdl-cell--8-col-tablet mdl-cell--4-col-phone' },
          React.createElement(
            'form',
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('input', { className: 'mdl-textfield__input', type: 'text', defaultValue: eventTitle, name: 'eventTitle' + eventId, ref: 'eventTitle' + eventId, id: 'eventTitle' + eventId }),
                React.createElement(
                  'label',
                  { className: 'mdl-textfield__label', htmlFor: 'eventTitle' + eventId },
                  'Title...'
                )
              )
            )
  ...
  selectEvent(event) {
    ...
    if (this.state.selectedEvent == event) {
      ...
      const updatedEvent = _extends({}, event);

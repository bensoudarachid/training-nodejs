      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('h1', { className: 'glyphicon glyphicon-exclamation-sign' })
          ),
          React.createElement(
            'div',
          ...
          React.createElement(
            ...
            React.createElement(
              'button',
              { onClick: event => this.handleClose(event), className: 'mdl-button mdl-js-button mdl-button--raised mdl-button--colored' },
              'Ok'
            )
          )
        )

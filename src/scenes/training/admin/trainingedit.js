...
//training={this.props.trainingappmap.get('edittraining')}
    ...
    return (
            ...
            <div className='trainingedit blockborder'>
              ...
              <span className='mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone'><div className={errorClass}>{error}</div></span>
              ...
              <div key={'trainingeditbuttonsarenotrerenderedproperlyaftersubmit'+Math.random()}>
                ...
                <button onClick={(event) => this.handleDelete(event)} className='mdl-button mdl-js-button mdl-button--raised mdl-button--colored'>
                  Delete
                </button>
              </div>
              }

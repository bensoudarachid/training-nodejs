  ...
  render() {
    ...
    <ul className='navbar-header logoblock'>
		...
		<div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<li><IndexLink activeClassName='active' to='/'>HomeA</IndexLink></li>
      <li><Link activeClassName='active' to='/todos'>TodosA</Link></li>
      <li><Link activeClassName='active' to='/trainings'>TrainingA</Link></li>
			</ul>
			<ul className="nav navbar-nav navbar-right">
			<li><Link activeClassName='active' to='/register'>RegisterA</Link></li>
